...
export default function Footer(){
    return(
        <footer className="  bg-transparent text-white py-12 px-4 font-sans tracking-wide">
        <div className="text-center">
          <h6 className="text-base">Stay connected with us:</h6>
  
          <ul className="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
            <li><a href="https://www.facebook.com/profile.php?id=61561505900241" className="text-xl hover:text-gray-400">
            ...
            <li><a href="https://www.linkedin.com/in/hamza-khan-dev" className="text-xl hover:text-gray-400">
            ...
            <li><a href="https://www.instagram.com/code.with.hamza.dev/" className="text-xl hover:text-gray-400">
            ...
            <li><a href="https://github.com/hamzakhan60" className="text-xl hover:text-gray-400">
              <FaGithub color="white" size={35} /></a></li>
          </ul>
